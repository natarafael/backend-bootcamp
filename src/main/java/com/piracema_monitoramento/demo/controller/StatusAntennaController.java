...
import com.piracema_monitoramento.demo.entities.dtos.StatusAntennaDTO;
import com.piracema_monitoramento.demo.entities.dtos.StatusAntennaFormDTO;
import com.piracema_monitoramento.demo.services.StatusAntennaService;
...
public class StatusAntennaController {
    ...
    public ResponseEntity<StatusAntennaDTO> getById(@PathVariable Long id){
        try {
            ...
            log.error("Status não encontradra", e);
